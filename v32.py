...
class SimpleCubeMissionV32(Node):
    def __init__(self):
        super().__init__("simple_cube_mission_v32")
        ...
        print("[BOOT] SimpleCubeMission v32")
        ...
        print("[FLOW] search -> stop -> backtrack 1s -> fine align -> approach -> lost -> forward 1.5s -> arm down")
        print("[SAFETY] zone marker must be stable before target color changes")
    ...
    def handle_backup_after_release(self):
        ...
        self.set_state("SEARCH", f"continue searching clockwise, cycles={self.completed_cycles}")
