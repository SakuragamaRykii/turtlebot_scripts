...
# v40: exam-room mode. Faster lock, no one-second reverse correction.
SEARCH_ANG = 0.176
...
class SimpleCubeMissionV41(Node):
    def __init__(self):
        super().__init__("simple_cube_mission_v41")
        ...
        print("[BOOT] SimpleCubeMission v41")
