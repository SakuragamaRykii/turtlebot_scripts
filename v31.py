...
class SimpleCubeMissionV31(Node):
    def __init__(self):
        super().__init__("simple_cube_mission_v31")
        ...
        print("[BOOT] SimpleCubeMission v31")
        ...
        print("[SAFETY] marker timeout stops instead of searching with arm down")
